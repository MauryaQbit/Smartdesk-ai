...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-80 rounded-2xl border border-white/10 bg-zinc-900 shadow-2xl z-50 overflow-hidden backdrop-blur">
          <div className="p-3 flex justify-between items-center border-b border-white/5"><span className="font-medium text-sm text-white">Notifications</span><button onClick={markAll} className="text-xs text-indigo-300">Mark all read</button></div>
